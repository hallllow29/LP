...
Storage *newBusiness(Storage *businessList, int businessIndex) {
    ...
    setCompanyBUSINESS(businessList, BUSINESS_NAME, BUSINESS_INSERT);
    strcpy(BUSINESS_STATUS, "Inactive");

    BUSINESS_ACTIVE = 0;
    BUSINESS_USED = 0;
    printf(BUSINESS_ADDED, BUSINESS_NAME);
...
void businessDELETE(Storage *businessList, int businessIndex) {
    ...
    readString(input, MAX_LEN, BUSINESS_DEL_INSERT);
