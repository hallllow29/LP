...
Storage *newCompany(Storage *companyList, int index) {
    ...
    setCompanyCATG(companyList, COMPANY_CATEGORY, CATEGORY_INSERT);
...
int searchFeatureCompany(Storage *companyList, int option) {
    ...
    switch (option) {
        ...
        case searchCompanyByCategory:
            searchCompanyDATA(companyList, COMPANY_CATEGORY, CATEGORY_INSERT, NOT_FOR_USER);
            break;
        case searchCompanyByBusiness:
            searchCompanyDATA(companyList, COMPANY_ACTIVTY, BUSINESS_INSERT, NOT_FOR_USER);
            break;
