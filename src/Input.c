...
int companyDELETE(Storage *companyList, int index) {
    ...
    readString(input, MAX_LEN, COMPANY_DEL_INSERT);
...
void setCommentTITLE(Storage *companyList, int index, int id) {
    readString(COMPANY_COMMT_TITLE, MAX_LEN_TITLE, COMPANY_COMMENT_TITLE_INSERT);
}

void setCommentNAME(Storage *companyList, int index, int id) {
    readString(COMPANY_COMMT_NAME, MAX_LEN_NAME, COMPANY_COMMENT_NAME_INSERT);
}

void setCommentEMAIL(Storage *companyList, int index, int id) {
    readString(COMPANY_COMMT_EMAIL, MAX_LEN_EMAIL, COMPANY_COMMENT_EMAIL_INSERT);
}

void setCommentMESSAGE(Storage *companyList, int index, int id) {
    readString(COMPANY_COMMT_MSG, MAX_LEN_MESSAGE, COMPANY_COMMENT_MSG_INSERT);
}
