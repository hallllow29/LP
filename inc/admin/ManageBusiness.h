 ...
 *
 * @param businessList - A pointer to a Storage structure where the business 
 * list is stored.
 ...
 *
 * @param businessList - A pointer to a Storage structure, which may be NULL
 ...
 *
 * @param businessList - A pointer to a Storage structure that contains the business list.
 * @param businessIndex - The index of the business in the list that will be removed.
 * @param option - Option the user selects (remove or exit).
 *
 * @return Returns the updated business list.
**/
 ...
 * name of the business at the specified index.
 *
 * @param businessList - A pointer to a Storage structure where the business 
 * is stored.
 * @param businessIndex - The index of the business in the list to be removed.
**/
 ...
 *
 * @param businessList - A pointer to the Storage structure where the business 
 * list is stored
 * 
 * @return Returns the index of the selected business.
**/
 ...
 * @param businessList - A pointer to a Storage structure where the business 
 * list is stored.
 * @return Returns the business list updated.
**/
