 ...
 * @copyright   ESTG IPP
 * @brief       Header file of the company structure.
 * @date        30/11/2023
**/

#ifndef INC_STRUCT_COMPANYSTRUCTURE_H_
#define INC_STRUCT_COMPANYSTRUCTURE_H_
#include "CommentStructure.h"
#include "BusinessStructure.h"
...
#endif //INC_STRUCT_COMPANYSTRUCTURE_H_
