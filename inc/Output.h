...
#define TITLE_CATALOG "\t\t\t\t\t\t\t\t\t\t\t\t[MANAGE CATALOG MENU]"
...
#define TITLE_COMPANY_FOUND "\t\t\t\t\t\t\t\t\t\t\t\t  COMPANY FOUND!!!"

#define TITLE_BUSINESS "\t\t\t\t\t\t\t\t\t\t\t\t[MANAGE BUSINESS MENU]"
#define TITLE_BUSINESS_ADD "\t\t\t\t\t\t\t\t\t\t\t\t   [ADD] BUSINESS"
#define TITLE_BUSINESS_EDIT "\t\t\t\t\t\t\t\t\t\t\t\t  [EDIT] BUSINESS"
#define TITLE_BUSINESS_DEL "\t\t\t\t\t\t\t\t\t\t\t\t [REMOVE] BUSINESS"

#define TITLE_ACCESS "\t\t\t\t\t\t\t\t\t\t\t\t[ACCESS COMPANY MENU]"
#define TITLE_REPORT "\t\t\t\t\t\t\t\t\t\t\t\t[MANAGE REPORT MENU]"
#define TITLE_COMPANY_ANALYTICS "\t\t\t\t\t\t\t\t\t\t\t\t [ANALYTICS] COMPANY"

#define TITLE_USER "\t\t\t\t\t\t\t\t\t\t\t\t     [USER MENU]"
#define TITLE_COMPANY_RATING "\t\t\t\t\t\t\t\t\t\t\t\t   [RATE] COMPANY"


#define TITLE_COMPANY_COMMENTS "\t\t\t\t\t\t\t\t\t\t\t\t COMPANY COMMENTS"
...
#define BUSINESS_ADDED "\nBUSINESS %s WAS ADDED TO THE LIST WITH SUCCESS!\n"

// BUSINESS:
#define BUSINESS_INSERT "\nInsert company Business: "
#define BUSINESS_MISSING "\nDO NOT FORGET TO UPDATE COMPANY INFORMATION.\nIN REGARDS TO BUSINESS OF %s\n"
#define BUSINESS_NO_DELETE "IS NOT POSSIBLE TO REMOVE THE BUSINESS WHILE ITS STATUS IS ACTIVE OR ITS IN USE!"
...
// DELETE:
#define COMPANY_DEL_INSERT "To remove this company, please retype\nthe name of the company and press enter: "
#define BUSINESS_DEL_INSERT "To remove this business, please retype\nthe name of the company and press enter: "
#define COMPANY_DEL_SUCCESS "Company removed with success!"
#define COMPANY_SIGN_IN "\t\t\t\t\t\t\t\t\t\t\t\t [COMPANY SIGN IN]"
...
// COMMENT:
#define COMPANY_COMMENT_TITLE_INSERT "\nTITLE: "
#define COMPANY_COMMENT_NAME_INSERT "\nNAME: "
#define COMPANY_COMMENT_EMAIL_INSERT "\nEMAIL: "
#define COMPANY_COMMENT_MSG_INSERT "\nCOMMENT: "
#define NO_DEL_COMPANY "DELETING A COMPANY WITH COMMENTS IS NOT POSSIBLE!"
#define COMMENT_NOT_FOUND "COMMENT NOT FOUND!"
#define COMMENT_ID "COMMENT WITH THE ID: %d"
#define COMMENT_DELETED "Comment removed with success!"
...
/**
 * @brief Displays the menu to remove business.
 *
 ...
 */
void businessRemoveDisplay(Storage *businessList, int businessIndex);
...
/**
 * @brief Get the index of activity of a company.
 *
