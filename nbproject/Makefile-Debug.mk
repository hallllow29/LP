...
${OBJECTDIR}/src/Input.o: src/Input.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Input.o src/Input.c

${OBJECTDIR}/src/MainMenu.o: src/MainMenu.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MainMenu.o src/MainMenu.c

${OBJECTDIR}/src/Output.o: src/Output.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Output.o src/Output.c

${OBJECTDIR}/src/admin/AdminMenu.o: src/admin/AdminMenu.c
	${MKDIR} -p ${OBJECTDIR}/src/admin
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/admin/AdminMenu.o src/admin/AdminMenu.c

${OBJECTDIR}/src/admin/ManageBusiness.o: src/admin/ManageBusiness.c
	${MKDIR} -p ${OBJECTDIR}/src/admin
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/admin/ManageBusiness.o src/admin/ManageBusiness.c

${OBJECTDIR}/src/admin/ManageCatalog.o: src/admin/ManageCatalog.c
	${MKDIR} -p ${OBJECTDIR}/src/admin
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/admin/ManageCatalog.o src/admin/ManageCatalog.c

${OBJECTDIR}/src/admin/ManageReport.o: src/admin/ManageReport.c
	${MKDIR} -p ${OBJECTDIR}/src/admin
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/admin/ManageReport.o src/admin/ManageReport.c

${OBJECTDIR}/src/company/AccessComment.o: src/company/AccessComment.c
	${MKDIR} -p ${OBJECTDIR}/src/company
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/company/AccessComment.o src/company/AccessComment.c

${OBJECTDIR}/src/company/AccessCompany.o: src/company/AccessCompany.c
	${MKDIR} -p ${OBJECTDIR}/src/company
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/company/AccessCompany.o src/company/AccessCompany.c

${OBJECTDIR}/src/company/AccessReport.o: src/company/AccessReport.c
	${MKDIR} -p ${OBJECTDIR}/src/company
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/company/AccessReport.o src/company/AccessReport.c

${OBJECTDIR}/src/company/CompanyMenu.o: src/company/CompanyMenu.c
	${MKDIR} -p ${OBJECTDIR}/src/company
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/company/CompanyMenu.o src/company/CompanyMenu.c
...
${OBJECTDIR}/src/user/SubmitSearch.o: src/user/SubmitSearch.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/user/SubmitSearch.o src/user/SubmitSearch.c

${OBJECTDIR}/src/user/SubtmitComment.o: src/user/SubtmitComment.c
	${MKDIR} -p ${OBJECTDIR}/src/user
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/user/SubtmitComment.o src/user/SubtmitComment.c

${OBJECTDIR}/src/user/SubtmitRating.o: src/user/SubtmitRating.c
	${MKDIR} -p ${OBJECTDIR}/src/user
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/user/SubtmitRating.o src/user/SubtmitRating.c

${OBJECTDIR}/src/user/UserMenu.o: src/user/UserMenu.c
	${MKDIR} -p ${OBJECTDIR}/src/user
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/user/UserMenu.o src/user/UserMenu.c
